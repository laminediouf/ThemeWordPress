					...
					<div class="container inner-table">
						<div class="inner-table-cell">
							<div class="caption verticle-center text-center wow zoomIn">
								...
								<?php if( get_post_meta(get_the_ID(),'heropress_slidebutton', true ) ): ?>
									<a href="<?php echo esc_url( get_post_meta( get_the_ID(),'heropress_slidebutton', true) ); ?>" class="specia-btn-3">
										<?php echo _e( 'Read More','heropress' ); ?> 
									</a>
								<?php
									endif;
								?>
