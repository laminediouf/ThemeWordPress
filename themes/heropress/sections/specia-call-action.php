...
?>
<section class="call-to-action-three wow fadeInDown" style="background: url('<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/images/features.jpg') no-repeat fixed 0 0 / cover rgba(0, 0, 0, 0);">
        ...
        <div class="container">
            <div class="row padding-top-90 padding-bottom-90">
                ...
                <div class="col-md-12 text-center">
					...
					?>
                    <h2 class="<?php echo esc_attr($call_action_effect); ?>"> <?php the_title(); ?></h2>
