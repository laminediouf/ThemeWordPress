...
// Blog Section
	Ellie_Kirki_Customizer::add_section( 'blog', array(
		...
		'priority'   => 5,
		'capability' => 'edit_theme_options',
		'active_callback' => 'TZ_Theme_Helper::is_blog',
	) );
...
// Post Section
	Ellie_Kirki_Customizer::add_section( 'post', array(
		...
		'priority'   => 5,
		'capability' => 'edit_theme_options',
		'active_callback' => 'TZ_Theme_Helper::is_post',
	) );
...
// Shop Section
	Ellie_Kirki_Customizer::add_section( 'shop', array(
		...
		'priority'   => 5,
		'capability' => 'edit_theme_options',
		'active_callback' => 'TZ_Theme_Helper::is_shop',
	) );
...
// Product Section
	Ellie_Kirki_Customizer::add_section( 'product', array(
		...
		'priority'   => 5,
		'capability' => 'edit_theme_options',
		'active_callback' => 'TZ_Theme_Helper::is_product',
	) );
...
// Typography Start
	...
	Ellie_Kirki_Customizer::add_field( TZ_THEME_PREFIX.'_theme', array(
		...
		'section'     => 'typography',
		'active_callback' => 'TZ_Theme_Helper::is_blog_post',
		'default'     => array(
			'font-family'    => 'HK Grotesk',
			'variant'        => '700',
			'font-size'      => '14px',
...
// Sidebar Layout Start
	...
	Ellie_Kirki_Customizer::add_field( TZ_THEME_PREFIX.'_theme', array(
		...
		'default'     => 'right',
		'priority'    => 1,
		'active_callback' => 'TZ_Theme_Helper::is_search',
		'choices'     => array(
			'left'   => get_template_directory_uri() . '/assets/img/two-col-left.png',
			'right'  => get_template_directory_uri() . '/assets/img/two-col-right.png',
			'no'     => get_template_directory_uri() . '/assets/img/one-col.png',
	...
	Ellie_Kirki_Customizer::add_field( TZ_THEME_PREFIX.'_theme', array(
		...
		'default'     => 'right',
		'priority'    => 1,
		'active_callback' => 'TZ_Theme_Helper::is_page',
		'choices'     => array(
			'left'   => get_template_directory_uri() . '/assets/img/two-col-left.png',
			'right'  => get_template_directory_uri() . '/assets/img/two-col-right.png',
			'no'     => get_template_directory_uri() . '/assets/img/one-col.png',
	...
	Ellie_Kirki_Customizer::add_field( TZ_THEME_PREFIX.'_theme', array(
		...
		'default'     => 'no',
		'priority'    => 1,
		'active_callback' => 'TZ_Theme_Helper::is_cart',
		'choices'     => array(
			'left'   => get_template_directory_uri() . '/assets/img/two-col-left.png',
			'right'  => get_template_directory_uri() . '/assets/img/two-col-right.png',
			'no'     => get_template_directory_uri() . '/assets/img/one-col.png',
	...
	Ellie_Kirki_Customizer::add_field( TZ_THEME_PREFIX.'_theme', array(
		...
		'default'     => 'no',
		'priority'    => 1,
		'active_callback' => 'TZ_Theme_Helper::is_checkout',
		'choices'     => array(
			'left'   => get_template_directory_uri() . '/assets/img/two-col-left.png',
			'right'  => get_template_directory_uri() . '/assets/img/two-col-right.png',
			'no'     => get_template_directory_uri() . '/assets/img/one-col.png',
